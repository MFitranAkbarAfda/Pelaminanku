...
const testimonials = [
  {
    ...
    hint: "happy couple",
    comment: "Pelaminanku bikin persiapan nikahan jadi gampang banget! Nemu WO dan vendor lain tanpa ribet. Semuanya profesional!",
    position: "self-start",
  },
  {
    ...
    comment: "Sejak join Pelaminanku, bisnis dekorasi saya makin dikenal. Banyak klien baru yang saya dapat dari platform ini. Mantap!",
    position: "self-end",
  },
  {
    name: "Bimo & Sarah",
    ...
    comment: "Fitur checklist dan budget plannernya sangat membantu kami yang awam. Pernikahan kami berjalan lancar. Terima kasih Pelaminanku!",
    position: "self-start",
  },
];
