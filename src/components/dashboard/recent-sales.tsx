    ...
    return (
      <div className="space-y-8">
        ...
        <div className="flex items-center">
          ...
          <div className="ml-auto font-medium">+Rp 390.000</div>
        </div>
        <div className="flex items-center">
          <Avatar className="h-9 w-9">
        ...
        <div className="flex items-center">
          <Avatar className="h-9 w-9">
            <AvatarImage src="https://placehold.co/40x40.png" alt="Avatar" data-ai-hint="man smiling"/>
          ...
          <div className="ml-auto font-medium">+Rp 999.000</div>
        </div>
        <div className="flex items-center">
          <Avatar className="h-9 w-9">
            <AvatarImage src="https://placehold.co/40x40.png" alt="Avatar" data-ai-hint="woman smiling"/>
